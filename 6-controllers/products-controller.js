...
router.get("/products", verify_log_in_1.default, function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var products, err_1;
...
router.get("/products/:_id", verify_log_in_1.default, function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _id, product, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
router.post("/products", verify_admin_1.default, function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var category, product, addedProduct, err_3;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, category_model_1.CategoryModel.findOne({ name: request.body.category })];
            case 1:
                category = _b.sent();
                product = new product_model_1.ProductModel(request.body);
                product.categoryId = category === null || category === void 0 ? void 0 : category._id;
...
router.put("/products/:_id", verify_admin_1.default, function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _id, category, product, updatedProduct, err_4;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
    ...
    return __generator(this, function (_a) {
        try {
            ...
            if (!fs_1.default.existsSync(absolutePath)) {
                throw new error_models_1.RouteNotFoundError(request.method, request.originalUrl);
            }
...
router.get("/products-count", function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var productsCount, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, products_logic_1.default.getProductsCount()];
            case 1:
