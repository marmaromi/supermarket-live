...
function login(credentials) {
    return __awaiter(this, void 0, void 0, function () {
        var user, userNoPassword, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    credentials.password = (0, cyber_hash_1.default)(credentials.password);
                    return [4 /*yield*/, credentials_model_1.CredentialsModel.findOne({ email: credentials.email, password: credentials.password }).exec()];
                case 1:
                    user = _a.sent();
                    if (!user) {
                        throw new error_models_1.ValidationError("\u05E9\u05DD \u05DE\u05E9\u05EA\u05DE\u05E9 \u05D0\u05D5 \u05E1\u05D9\u05E1\u05DE\u05D0 \u05E9\u05D2\u05D5\u05D9\u05D9\u05DD");
                    }
                    userNoPassword = user.toObject();
